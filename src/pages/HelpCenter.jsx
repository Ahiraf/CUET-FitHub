...
const faqs = [
  ...
  { q: 'How do I know if the gym is full?', a: 'The Overview dashboard shows live occupancy against the 50-student daily capacity. When attendance crosses 50, the gym is flagged as full so you can avoid a wasted trip. Use the Check in / Check out button when you arrive and leave.' },
  { q: 'How do I log a workout?', a: 'Open "My workout" to follow your assigned routine and check off exercises, or build your next session under "Exercises" by adding movements to your plan.' },
  ...
  { q: 'How do I report broken equipment?', a: 'Open "Facilities", describe the issue in the report form, and submit. Admins track and resolve the ticket, and you can see its status.' },
